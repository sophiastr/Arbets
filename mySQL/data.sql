...
insert into team_game values(2,2);
insert into team_game values(1,3);
insert into team_game values(3,3);
insert into team_game values(4,4);
insert into team_game values(6,4);
insert into team_game values(6,5);
insert into team_game values(4,5);
insert into team_game values(2,6);
insert into team_game values(4,6);
insert into team_game values(3,7);
insert into team_game values(1,7);
insert into team_game values(2,8);
insert into team_game values(4,8);
insert into team_game values(1,9);
insert into team_game values(3,9);
insert into team_game values(4,10);
insert into team_game values(2,10);
insert into team_game values(2,11);
insert into team_game values(4,11);
insert into team_game values(6,12);
insert into team_game values(2,12);
insert into team_game values(2,13);
insert into team_game values(4,13);
insert into team_game values(6,14);
insert into team_game values(4,14);
insert into team_game values(1,15);
insert into team_game values(3,15);
insert into team_game values(6,16);
insert into team_game values(2,16);
insert into team_game values(5,17);
insert into team_game values(1,17);
insert into team_game values(1,18);
insert into team_game values(3,18);
insert into team_game values(2,19);
insert into team_game values(4,19);
insert into team_game values(6,20);
insert into team_game values(2,20);
...
insert into answer(date,text, user_id, upvote, downvote, is_solution) values("2022-02-04 22:45:34","Eίναι 3890€", 2, 2, 0, true, 1);
insert into answer(date,text, user_id, upvote, downvote, is_solution) values("2022-02-04 22:55:54","Όχι, το ψάχνω και εγώ", 3, 0, 0, false,1);
insert into answer(date,text, user_id, upvote, downvote, is_solution) values("2022-02-04 22:55:54","Μεγάλη ευκαρία", 3, 7, 0, false,2);
